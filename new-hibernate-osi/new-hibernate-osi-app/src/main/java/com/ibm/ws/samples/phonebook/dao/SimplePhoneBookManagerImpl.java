 ...
 */
package com.ibm.ws.samples.phonebook.dao;

import com.ibm.ws.samples.phonebook.PhoneBookEntry;
...
public class SimplePhoneBookManagerImpl implements SimplePhoneBookManager {
    ...
    @Override
    public List<PhoneBookEntry> listPhones() {
        return sessionFactory.getCurrentSession().createQuery("from PhoneBookEntry").list();
    }
